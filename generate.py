...
for tms in INTEGRATIONS:
    ...
    tms_quality_estimation_api_integrations = tms.get('quality_estimation_api_integrations', [])
    ...
    frontmatter = {
      'autogenerated': True,
      'layout': 'integration',
      'nav_order': 1000 - (len(api_integrations) + len(tms_quality_estimation_api_integrations)),
      'title':  tms_name,
      'description': desc,
      'id': tms_id,
      'parent': 'Integrations',
...
for estimation in QUALITY_ESTIMATION:
  ...
  company = estimation['company'].title().replace('-',' ')
