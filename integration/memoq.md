## How to set up machine translation plugins in memoQ Translator Pro 9.8™  
...
![How to set up the memoQ Translator Pro 9.8™ plugin for Amazon Translate (AWS) (for a local profile)pic1](memoq_for_amazon1.png)

2. Click **Options**. A new pane appears. Click **Options** in the **memoQ options** menu. Wait for the **Default resources** pane to open.
 
![How to set up the memoQ Translator Pro 9.8™ plugin for Amazon Translate (AWS) (for a local profile)pic2](memoq_for_amazon2.png)
...
![How to set up the memoQ Translator Pro 9.8™ plugin for Amazon Translate (AWS) (for a local profile)pic3](memoq_for_amazon3.png)
...
![How to set up the memoQ Translator Pro 9.8™ plugin for Amazon Translate (AWS) (for a local profile)pic4](memoq_for_amazon4.png)
...
![How to set up the memoQ Translator Pro 9.8™ plugin for Amazon Translate (AWS) (for a local profile)pic5](memoq_for_amazon5.png)
...
![How to set up the memoQ Translator Pro 9.8™ plugin for Amazon Translate (AWS) (for a local profile)pic6](memoq_for_amazon6.png)  
...
![How to set up the memoQ Translator Pro 9.8™ plugin for DeepLpic1](memoq_for_amazon1.png)  


2. Click **Options**. A new pane appears. Click **Options** in the **memoQ options** menu. Wait for the **Default resources** pane to open.  


![How to set up the memoQ Translator Pro 9.8™ plugin for DeepLpic2](memoq_for_amazon2.png)  
...
![How to set up the memoQ Translator Pro 9.8™ plugin for DeepLpic3](memoq_for_amazon3.png)  

 
5. If you have not set up an MT profile yet, open the **Language** drop-down menu, and select a language. In the **Name/description** field enter a name. Click **Create new** at the bottom of the pane. In the **Create new MT settings** window enter the name and description. Click **OK**. Check the new profile visible in the list. Click **OK** to confirm that you read the message > **Edit**.  

	
![How to set up the memoQ Translator Pro 9.8™ plugin for DeepLpic4](memoq_for_amazon4.png)  
...
![How to set up the memoQ Translator Pro 9.8™ plugin for DeepLpic5](memoq_for_deepl5.png)  
...
![How to set up the memoQ Translator Pro 9.8™ plugin for DeepLpic6](memoq_for_deepl6.png)  
...
![How to set up the memoQ Translator Pro 9.8™ plugin for ModernMTpic1](memoq_for_amazon1.png)  


2. Click **Options**. A new pane appears. Click **Options** in the **memoQ options** menu. Wait for the **Default resources** pane to open.  


![How to set up the memoQ Translator Pro 9.8™ plugin for ModernMTpic2](memoq_for_amazon2.png)  
...
![How to set up the memoQ Translator Pro 9.8™ plugin for ModernMTpic3](memoq_for_amazon3.png)  


 5. If you have not set up an MT profile yet, open the **Language** drop-down menu, and select a language. In the **Name/description** field enter a name. Click **Create new** at the bottom of the pane. In the **Create new MT settings** window enter the name and description. Click **OK**. Check the new profile visible in the list. Click **OK** to confirm that you read the message > **Edit**.  

	
![How to set up the memoQ Translator Pro 9.8™ plugin for ModernMTpic4](memoq_for_amazon4.png)  
...
6. In the **Edit machine translation settings** windows go to the **Services** tab and check the **Modern MT Plugin**. Click **OK** to confirm that you read the message. To prevent this message from displaying again, check **Do not show this warning** option. Click the cogwheel icon or double-click the name of the plugin.  
 ...
 ![How to set up the memoQ Translator Pro 9.8™ plugin for ModernMTpic5](memoq_for_modernmt5.png)  

 
7. In the **Modern MT settings** enter your Modern MT API key in the field. Click  **Login**.  


 ![How to set up the memoQ Translator Pro 9.8™ plugin for ModernMTpic6](memoq_for_modernmt6.png)  
...
8. You may select one or more translation memories to use with your project. Check the **Use** check box for each translation memory you wish to use. If you check the **Update** check box of a translation memory, it will learn from the corrections you make in a given translation. You may select this check box for only one translation memory.  
 ...
 ![How to set up the memoQ Translator Pro 9.8™ plugin for ModernMTpic7](memoq_for_modernmt7.png)  
...
![How to set up the memoQ Translator Pro 9.8™ plugin for Google Cloud Translation Basicpic1](memoq_for_amazon1.png)  


2. Click **Options**. A new pane appears. Click **Options** in the **memoQ options** menu. Wait for the **Default resources** pane to open.  

 
![How to set up the memoQ Translator Pro 9.8™ plugin for Google Cloud Translation Basicpic2](memoq_for_amazon2.png)
...
![How to set up the memoQ Translator Pro 9.8™ plugin for Google Cloud Translation Basicpic3](memoq_for_amazon3.png)


5. If you have not set up an MT profile yet, open the **Language** drop-down menu, and select a language. In the **Name/description** field enter a name. Click **Create new** at the bottom of the pane. In the **Create new MT settings** window enter the name and description. Click **OK**. Check the new profile visible in the list. Click **OK** to confirm that you read the message > **Edit**.  


![How to set up the memoQ Translator Pro 9.8™ plugin for Google Cloud Translation Basicpic4](memoq_for_amazon4.png)  
...
![How to set up the memoQ Translator Pro 9.8™ plugin for Google Cloud Translation Basicpic5](memoq_for_google1.png)  
...
![How to set up the memoQ Translator Pro 9.8™ plugin for Google Cloud Translation Basicpic6](memoq_for_google2.png)  
