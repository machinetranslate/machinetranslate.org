...
State-of-the-art neural language models are based on the [Transformer architecture](/building-and-research/approaches/advanced/transformers.md), either the encoder (e.g. BERT) or the decoder (e.g. GPT).
