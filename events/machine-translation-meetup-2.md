...
> >
> > For benchmark data (like [FLORES](../features/customisation/parallel-data.md)) crowdsourcing translation is not appropriate, as it lacks the quality process needed.
> >
...
> > Probably.
> >
> > Most of the evaluation metrics right (say in the metrics task at [WMT](../more/associations/wmt.md)) are focused on cases where minute differences of high-quality translations are important (dissemination), while others like [BLEU](../building-and-research/metrics/bleu.md)/XSTS are more than adequate for assimilation use cases.
